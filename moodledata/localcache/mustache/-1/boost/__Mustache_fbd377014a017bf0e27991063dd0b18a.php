...
class __Mustache_fbd377014a017bf0e27991063dd0b18a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'headeractions' => array($this, 'block97edf38f1aee044ecf03eb12c407435e'),
...
';
    ...
    public function block97edf38f1aee044ecf03eb12c407435e($context)
    {
        $indent = $buffer = '';
