...
class __Mustache_def91967ce6eed561e81894f4ee67d81 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '//<footer id="page-footer" class="py-3 bg-light text-light align-center">
';
